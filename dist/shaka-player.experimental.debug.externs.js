...
shaka.util.EventManager = class {
   ...
   * @return {undefined}
   */
  listenMulti(target, types, listener, options) {}
  /**
   ...
   * @return {undefined}
   */
  listenOnceMulti(target, types, listener, options) {}
  /**
...
shaka.text.TextEngine = class {
   ...
   */
  constructor(displayer, manifestType) {}
  /**
   * @param {string} mimeType
...
shaka.media.PresentationTimeline = class {
  ...
  isInProgress() {}
  /**
   * @return {boolean} True if the presentation is live or in progress (meaning
   *   not live, but also not completely available); otherwise, return false.
   */
  isDynamic() {}
  /**
...
shaka.Player = class extends shaka.util.FakeEventTarget {
   ...
   * @return {!Promise}
   */
  detach(keepAdManager, isSwitchingContent) {}
  /**
   ...
   * @return {!Promise}
   */
  unload(initializeMediaSource, keepAdManager, isSwitchingContent) {}
  /**
   ...
   */
  unloadAndSavePreload(initializeMediaSource, keepAdManager, savePosition, isSwitchingContent) {}
  /**
   ...
   * @return {!Promise<?shaka.media.PreloadManager>}
   */
  detachAndSavePreload(keepAdManager, savePosition, isSwitchingContent) {}
  /**
   ...
   */
  retryLicensing(sessionMetadata, retryDelaySeconds) {}
  /**
 ...
 * @const {string}
 */
shaka.ads.Utils.AD_INTERSTITIAL_PRELOAD;
/**
 * The event name for when the ad manager finish the preload of an interstitial.
 * @const {string}
 */
shaka.ads.Utils.AD_INTERSTITIAL_PRELOADED;
/**
...
/**
     * @protected {boolean}
     */
shaka.ui.Element.prototype.isSubMenu;
/**
     * @protected {boolean}
     */
shaka.ui.Element.prototype.isSubMenuOpened;
/**
 * @final
 */
shaka.ui.Icon = class {
...
shaka.ui.MediaSession = class {
   ...
   * @return {undefined}
   */
  addMediaSessionHandler(type, callback) {}
  /**
